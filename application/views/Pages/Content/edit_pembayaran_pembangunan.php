          ...
          <div class="col-md-12">
        	...
        	<?php }?>
              <div class="card-header ">
                <h5 class="card-title"><center>Edit Pembayaran Pembangunan</center></h5>
				<div class="form-row">
					<div class="form-group col-md-4">
					</div>
					<div class="form-group col-md-4">
						<form method="post" action="<?php echo base_url('index.php/Pegawai_Controller/update_uang_pembangunan/'.$id)?>">
